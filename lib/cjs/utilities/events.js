...
*eventlistener para que cuando se hace click en nextJoke y hay un tab check, se guarde el scoring
* id = scoring-form
* onclick -> check if there's score
* if there's score -> update score
* after creating joke
* save joke into an array (push)
*
